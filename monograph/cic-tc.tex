...
\begin{listofabbrv}{MCTS}
    ...
    \item[UCB]  \emph{Upper Confidence Bound}
...
Em conformidade com as diretrizes contemporâneas de transparência acadêmica e científica, esta nota tem como objetivo documentar o uso de ferramentas de Inteligência Artificial (IA) generativa, especificamente modelos de linguagem de grande escala (LLMs), durante o desenvolvimento deste Trabalho de Conclusão de Curso. As ferramentas foram utilizadas com propósitos específicos e restritos, atuando como assistentes para otimizar o fluxo de trabalho.
